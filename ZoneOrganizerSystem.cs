...
public partial class ZoneOrganizerSystem : GameSystemBase
{
	...
	protected override void OnCreate()
	{
		...
		_uiAssetMenuDataQuery = GetEntityQuery(new EntityQueryDesc
			{ All = [ComponentType.ReadWrite<UIAssetMenuData>()] });
		_uiAssetCategoryDataQuery = GetEntityQuery(new EntityQueryDesc
			{ All = [ComponentType.ReadWrite<UIAssetCategoryData>()] });
		...
		GameManager.instance.RegisterUpdater(IndexZones);
		GameManager.instance.RegisterUpdater(EditZones);
	}
	...
	{
		CreateUIAssetCategoryPrefab("Low Density Residential", "Zones", "Media/Game/Icons/ZoneResidentialLow.svg", 1);
		CreateUIAssetCategoryPrefab("Medium Density Residential", "Zones", "Media/Game/Icons/ZoneResidentialMedium.svg", 2);
		CreateUIAssetCategoryPrefab("High Density Residential", "Zones", "Media/Game/Icons/ZoneResidentialHigh.svg", 3);
